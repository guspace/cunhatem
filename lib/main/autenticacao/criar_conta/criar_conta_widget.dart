...
class _CriarContaWidgetState extends State<CriarContaWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'criarConta'});
    if (!isWeb) {
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('CRIAR_CONTA_arrow_back_rounded_ICN_ON_TA');
              context.pop();
            },
          ),
          actions: const [],
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  12.0, 0.0, 12.0, 12.0),
                              child: Text(
                                'Criar uma conta no CunhaTem. Essa função é restrita aos administradores.',
                                textAlign: TextAlign.start,
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                  ...
                  if (!(isWeb
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('CRIAR_CONTA_PAGE_btnSignup_ON_TAP');
                          Function() navigate = () {};
                          _model.emails = await queryAppConfiguracoesRecordOnce(
                            singleRecord: true,
                          ).then((s) => s.firstOrNull);
                          if (_model.emails!.adminEmails.contains(
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'Usuário não permitido. Entre em contato com o suporte',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)
