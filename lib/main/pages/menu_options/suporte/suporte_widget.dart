...
import '/main/pages/modais/suporte_enviar/suporte_enviar_widget.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AppConfiguracoesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AppConfiguracoesRecord> suporteAppConfiguracoesRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final suporteAppConfiguracoesRecord =
            suporteAppConfiguracoesRecordList.isNotEmpty
                ? suporteAppConfiguracoesRecordList.first
                : null;
                          ...
                          children: [
                            Align(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'SUPORTE_PAGE_chevron_left_ICN_ON_TAP');
                                  context.safePop();
                                },
                              ),
                            ),
            ...
            body: Column(
              ...
              children: [
                Expanded(
                  child: Builder(
                    builder: (context) {
                      final faqLista = suporteAppConfiguracoesRecord
                              ?.perguntasFrequentes
                              .toList() ??
                          [];
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('SUPORTE_PAGE_btnAjuda_ON_TAP');
                          ...
                          return WebViewAware(
                            child: GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: const SuporteEnviarWidget(),
                              ),
                            ),
                          );
                        },
