...
import 'dart:async';
import 'lista_experiencias_widget.dart' show ListaExperienciasWidget;
import 'package:flutter/material.dart';

class ListaExperienciasModel extends FlutterFlowModel<ListaExperienciasWidget> {
  ...
  List<ExperienciasRecord> simpleSearchResults = [];
  // State field(s) for PaginatedDataTable widget.
  final paginatedDataTableController =
      FlutterFlowDataTableController<ExperienciasRecord>();
